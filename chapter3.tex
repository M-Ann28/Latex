...
\begin{longtable}{p{4cm} p{9cm}}
	...
	& - The system shall issue automatic SMS notifications through GSM for overdue returns. \\
...
\begin{itemize}
	...
	\begin{equation}
		...
		\label{eq:solar}
	\end{equation}
	This equation determines the required rating for the solar charge controller. Dividing the total solar panel wattage (200W) by the system voltage (12V) yields the expected charging current supplied to the controller. The computed value of 16.67A is rounded upward to select a 20A MPPT charge controller, ensuring safe and efficient power regulation. Please refer to Appendix X for the detailed computation.
